...
user in an INI file next to AndroidStudioPortable.exe called AndroidStudioPortable.ini.
...
copy AppNamePortable.ini from this directory to AndroidStudioPortable.ini next to
AndroidStudioPortable.exe. The options in the INI file are as follows:
